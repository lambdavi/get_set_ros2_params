...
: ${AMENT_CURRENT_PREFIX:="/home/dave/team/test_ws/install/client"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/client/environment/pythonpath.sh"
